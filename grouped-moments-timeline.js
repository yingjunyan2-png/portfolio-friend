(() => {
  const media = (name) => name.includes('.') ? name : `assets/projects/media/${name}.png`;
    ...
    },
    {
      ...
      posts: [
        ...
        },
        {
          ...
          layout: 'phone-pair',
          images: ['p11-i05', 'p11-i06']
        },
        {
          title: '3. 宣传与现场物料',
          text: '制作适配线上传播的宣传物料与活动须知，并参与印刷沟通、物料核对、现场布置和活动协作。',
          layout: 'wide-pair',
          images: ['p11-i07', 'p11-i08']
        }
      ]
    }
  ];
