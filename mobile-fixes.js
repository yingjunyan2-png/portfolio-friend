(() => {
  ...
  const styles = [
    ...
    '#momentsPage .sub-section.pinned .gallery{display:flex!important;flex:1 1 auto!important;min-width:0!important;width:auto!important;height:64px!important;gap:5px!important;background:none!important;}',
    '#momentsPage .sub-section.pinned .gallery span{display:block!important;min-width:0!important;height:64px!important;flex:1 1 0!important;background-size:contain!important;background-repeat:no-repeat!important;background-color:#fff!important;background-position:center!important;}',
    ...
    '#momentsPage .moments-cover .cover-art{background-image:url("moments-background-optimized.webp")!important;background-color:transparent!important;filter:none!important;}',
    '#momentsPage .cover-profile p{display:none!important;}',
    '#momentsPage .cover-note{display:block!important;margin:0!important;padding:60px 22px 14px!important;background:#fff!important;border-bottom:1px solid #ececec!important;color:#747474!important;text-align:right!important;font-size:14px!important;line-height:1.5!important;white-space:nowrap!important;text-shadow:none!important;}',
    ...
    '#momentsPage .grouped-moment-copy h3{font-size:16px!important;line-height:1.45!important;color:#202423!important;}',
    '#momentsPage .grouped-moment-copy p{font-size:13px!important;line-height:1.75!important;color:#505756!important;}',
    '#momentsPage .grouped-moment-copy h4{font-size:15px!important;line-height:1.5!important;color:#2f3533!important;}',
    '#momentsPage .grouped-moment-copy small{font-size:11px!important;color:#929998!important;}',
    '#momentsPage .grouped-timeline .timeline-greeting p{font-size:13px!important;line-height:1.7!important;color:#555d5b!important;}',
    '#momentsPage .grouped-moment--moments-grid .layout-moments-grid{grid-template-columns:1fr!important;gap:8px!important;}',
    '#momentsPage .layout-moments-grid .project-media{width:100%!important;max-width:440px!important;margin:0 auto!important;}',
    '}'
  ].join('\n');
